...
*/
var arr = [1,false, null,undefined,"Valor"];
...
*/
console.log(retornaArray(arr)[2]);
...
array criado.
*/
console.log(valorIndice(array,0));
console.log(valorIndice(array,1));
console.log(valorIndice(array,2));
console.log(valorIndice(array,3));
console.log(valorIndice(array,4));
/*
