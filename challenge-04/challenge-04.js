...
*/
 carro.adicionarPessoas = function(numeroDePessoas){
    var totalPessoas = carro.quantidadedePessoas+numeroDePessoas;
    if(carro.quantidadedePessoas === carro.assentos && totalPessoas>=carro.assentos){
    return "O carro já está lotado";
    }  
    var lugaresVagos = carro.assentos - carro.quantidadedePessoas;
    var pessoa = lugaresVagos === 1 ? "pessoa" : "pessoas";
    if (totalPessoas > carro.assentos){
        return "Só cabem mais " + lugaresVagos + ' ' + pessoa;
    }
...
console.log(carro.obterModelo()); //ix35
...
console.log(carro.quantidadedePessoas);//5